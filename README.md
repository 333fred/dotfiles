...
2. Ensures required CLI utilities are installed in Codespaces, including `stow`, `bat`, `fzy`, GitHub CLI, and GitHub Copilot CLI, and installs the latest `git-delta` and `btm` releases from GitHub.
